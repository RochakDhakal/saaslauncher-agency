...
/**
 * Title: 404 Block
 * Slug: saaslauncher-agency/block-404
 * Categories: saaslauncher-agency-patterns
 */
$saaslauncher_agency_404_url = trailingslashit( get_stylesheet_directory_uri() );
$saaslauncher_agency_404_img = array(
	$saaslauncher_agency_404_url . 'assets/images/404.png',
);
?>
<!-- wp:group {"tagName":"main","metadata":{"patternName":"saaslauncher-agency/block-404","name":"404 Block","categories":["saaslauncher-agency-patterns"]},"style":{"spacing":{"padding":{"right":"26px","left":"26px","top":"42px","bottom":"42px"}}},"backgroundColor":"background-alt","layout":{"type":"constrained","contentSize":"100%"}} -->
<main class="wp-block-group has-background-alt-background-color has-background" style="padding-top:42px;padding-right:26px;padding-bottom:42px;padding-left:26px"><!-- wp:group {"style":{"spacing":{"padding":{"top":"0","bottom":"0","right":"var:preset|spacing|40","left":"var:preset|spacing|40"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"background-alt","fontSize":"xxxx-large","layout":{"type":"constrained","contentSize":"860px"}} -->
...
<?php
	echo esc_url( $saaslauncher_agency_404_img[0] );
?>
...
<?php
	esc_html_e( 'OOPS! Page Not Found!', 'saaslauncher-agency' );
?>
</h4>
<!-- /wp:heading --></div>
<!-- /wp:group --></div></div>
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40","right":"var:preset|spacing|40","left":"var:preset|spacing|40"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"background-alt","layout":{"type":"constrained","contentSize":"1260px"}} -->
<div class="wp-block-group has-background-alt-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"layout":{"type":"constrained","contentSize":"425px","justifyContent":"left"}} -->
...
<?php
	esc_html_e( 'Helpful Links', 'saaslauncher-agency' );
?>
</h3>
<!-- /wp:heading -->
...
<p>
<?php
	esc_html_e( "Something went wrong! We couldn't find the page you were looking for. But don't worry, we've got some other Links that might be helpful:", 'saaslauncher-agency' );
?>
</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<?php
	esc_html_e( 'Pages', 'saaslauncher-agency' );
?>
</h4>
<!-- /wp:heading -->

<!-- wp:page-list {"className":"is-style-homelancer-page-list-bullet-hide-style","style":{"typography":{"lineHeight":"2"}}} /--></div>
<!-- /wp:column -->
...
<!-- wp:categories {"showHierarchy":true,"showPostCounts":true,"className":"is-style-homelancer-categories-bullet-hide-style","style":{"typography":{"lineHeight":"2"},"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} /--></div>
<!-- /wp:column -->
...
<?php
	esc_html_e( 'Latest Posts', 'saaslauncher-agency' );
?>
</h4>
<!-- /wp:heading --></div>
<!-- /wp:group -->
