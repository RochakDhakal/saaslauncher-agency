...
/**
 * Title: What We Do
 * Slug: saaslauncher-agency/what-we-do
...
$saaslauncher_agency_url        = trailingslashit( get_stylesheet_directory_uri() );
	$saaslauncher_agency_images = array(
		$saaslauncher_agency_url . 'assets/images/how-we-work-1.jpg',
		$saaslauncher_agency_url . 'assets/images/how-we-work-2.jpg',
		$saaslauncher_agency_url . 'assets/images/how-we-work-3.jpg',
	);
	?>
<!-- wp:group {"metadata":{"patternName":"saaslauncher-agency/what-we-do","name":"What Wo Do","categories":["saaslauncher-agency-patterns"]},"style":{"spacing":{"blockGap":"0","margin":{"top":"0","bottom":"0"},"padding":{"top":"120px","bottom":"120px","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}}},"layout":{"type":"constrained","contentSize":"1260px"}} -->
...
<?php esc_html_e( 'What We Do', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph -->
...
<?php esc_html_e( 'Five disciplines, one accountable team.', 'saaslauncher-agency' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<p>
<?php esc_html_e( 'Strategy, design, engineering and growth under a single roof — so nothing gets lost between hand-offs.', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<?php esc_html_e( '01', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":3,"fontSize":"jumbo"} -->
<h3 class="wp-block-heading has-jumbo-font-size">
<?php esc_html_e( 'Website Design & Development', 'saaslauncher-agency' ); ?></h3>
<!-- /wp:heading -->
...
<?php esc_html_e( 'High-performance websites engineered to turn attention into revenue — fast, accessible, and built to scale.', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph -->
...
<li><?php esc_html_e( 'Design Systems', 'saaslauncher-agency' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
<li style="margin-top:var(--wp--preset--spacing--40)"><?php esc_html_e( 'Core Web Vitals', 'saaslauncher-agency' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->
...
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:list {"className":"is-style-list-style-check-circle","style":{"spacing":{"padding":{"right":"0","left":"0"}}}} -->
<ul style="padding-right:0;padding-left:0" class="wp-block-list is-style-list-style-check-circle"><!-- wp:list-item -->
<li><?php esc_html_e( 'Headless Builds', 'saaslauncher-agency' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
<li style="margin-top:var(--wp--preset--spacing--40)"><?php esc_html_e( 'CMS Training', 'saaslauncher-agency' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<p style="border-top-style:none;border-top-width:0px;border-right-style:none;border-right-width:0px;border-bottom-style:none;border-bottom-width:0px;border-left-color:var(--wp--preset--color--primary);border-left-width:2px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:var(--wp--preset--spacing--20)"><?php esc_html_e( 'Northbeam · +184% demo requests', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-light-color-color has-text-color has-link-color has-normal-font-size" style="margin-top:var(--wp--preset--spacing--60)"><a href="#"><?php esc_html_e( 'Learn More', 'saaslauncher-agency' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( $saaslauncher_agency_images[0] ); ?>","id":215,"isUserOverlayColor":true,"minHeight":460,"gradient":"gradient-2","sizeSlug":"full","style":{"border":{"radius":{"topLeft":"34px","topRight":"34px","bottomLeft":"34px","bottomRight":"34px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover" style="border-top-left-radius:34px;border-top-right-radius:34px;border-bottom-left-radius:34px;border-bottom-right-radius:34px;min-height:460px"><img class="wp-block-cover__image-background wp-image-215 size-full" alt="" src="<?php echo esc_url( $saaslauncher_agency_images[0] ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim wp-block-cover__gradient-background has-background-gradient has-gradient-2-gradient-background"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"placeholder":"Write title…","style":{"typography":{"textAlign":"center"}},"fontSize":"large"} -->
...
<p class="has-primary-color has-text-color has-link-color" style="border-top-left-radius:34px;border-top-right-radius:34px;border-bottom-left-radius:34px;border-bottom-right-radius:34px"><?php esc_html_e( '02', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":3,"fontSize":"jumbo"} -->
<h3 class="wp-block-heading has-jumbo-font-size"><?php esc_html_e( 'Branding & Creative Design', 'saaslauncher-agency' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|50"}}},"fontSize":"medium"} -->
<p class="has-medium-font-size" style="margin-top:var(--wp--preset--spacing--50)"><?php esc_html_e( 'Identity work with a point of view: naming, art direction, and systems that stay memorable everywhere.', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:list {"className":"is-style-list-style-check-circle","style":{"spacing":{"padding":{"right":"0","left":"0"}}}} -->
<ul style="padding-right:0;padding-left:0" class="wp-block-list is-style-list-style-check-circle"><!-- wp:list-item -->
<li><?php esc_html_e( 'Positioning', 'saaslauncher-agency' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
<li style="margin-top:var(--wp--preset--spacing--40)"><?php esc_html_e( 'Identity System', 'saaslauncher-agency' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->
...
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:list {"className":"is-style-list-style-check-circle","style":{"spacing":{"padding":{"right":"0","left":"0"}}}} -->
<ul style="padding-right:0;padding-left:0" class="wp-block-list is-style-list-style-check-circle"><!-- wp:list-item -->
<li><?php esc_html_e( 'Art Direction', 'saaslauncher-agency' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
<li style="margin-top:var(--wp--preset--spacing--40)"><?php esc_html_e( 'Brand Guidelines', 'saaslauncher-agency' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"var:preset|spacing|20","right":"0"}},"border":{"top":{"width":"0px","style":"none"},"right":{"width":"0px","style":"none"},"bottom":{"width":"0px","style":"none"},"left":{"color":"var:preset|color|primary","width":"2px"}}}} -->
<p style="border-top-style:none;border-top-width:0px;border-right-style:none;border-right-width:0px;border-bottom-style:none;border-bottom-width:0px;border-left-color:var(--wp--preset--color--primary);border-left-width:2px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:var(--wp--preset--spacing--20)"><?php esc_html_e( 'Aurum - Full Rebrand in 9 weeks.', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"primary","fontSize":"normal"} -->
<p class="has-primary-color has-text-color has-link-color has-normal-font-size"><?php esc_html_e( '03', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":3,"fontSize":"jumbo"} -->
<h3 class="wp-block-heading has-jumbo-font-size"><?php esc_html_e( 'SaaS & Product Design', 'saaslauncher-agency' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|50"}}},"fontSize":"medium"} -->
<p class="has-medium-font-size" style="margin-top:var(--wp--preset--spacing--50)"><?php esc_html_e( 'Intuitive product surfaces for complex software — onboarding, dashboards, and flows users actually finish.', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:list {"className":"is-style-list-style-check-circle","style":{"spacing":{"padding":{"right":"0","left":"0"}}}} -->
<ul style="padding-right:0;padding-left:0" class="wp-block-list is-style-list-style-check-circle"><!-- wp:list-item -->
<li><?php esc_html_e( 'Product Strategy', 'saaslauncher-agency' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
<li style="margin-top:var(--wp--preset--spacing--40)"><?php esc_html_e( 'UX architecture', 'saaslauncher-agency' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->
...
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:list {"className":"is-style-list-style-check-circle","style":{"spacing":{"padding":{"right":"0","left":"0"}}}} -->
<ul style="padding-right:0;padding-left:0" class="wp-block-list is-style-list-style-check-circle"><!-- wp:list-item -->
<li><?php esc_html_e( 'UI System', 'saaslauncher-agency' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item {"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
<li style="margin-top:var(--wp--preset--spacing--40)"><?php esc_html_e( 'Prototyping', 'saaslauncher-agency' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"var:preset|spacing|20","right":"0"}},"border":{"top":{"width":"0px","style":"none"},"right":{"width":"0px","style":"none"},"bottom":{"width":"0px","style":"none"},"left":{"color":"var:preset|color|primary","width":"2px"}}}} -->
<p style="border-top-style:none;border-top-width:0px;border-right-style:none;border-right-width:0px;border-bottom-style:none;border-bottom-width:0px;border-left-color:var(--wp--preset--color--primary);border-left-width:2px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:var(--wp--preset--spacing--20)"><?php esc_html_e( 'Nexora · Activation up 63%', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( $saaslauncher_agency_images[2] ); ?>","id":215,"isUserOverlayColor":true,"minHeight":460,"gradient":"gradient-2","sizeSlug":"full","style":{"border":{"radius":{"topLeft":"34px","topRight":"34px","bottomLeft":"34px","bottomRight":"34px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover" style="border-top-left-radius:34px;border-top-right-radius:34px;border-bottom-left-radius:34px;border-bottom-right-radius:34px;min-height:460px"><img class="wp-block-cover__image-background wp-image-215 size-full" alt="" src="<?php echo esc_url( $saaslauncher_agency_images[2] ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim wp-block-cover__gradient-background has-background-gradient has-gradient-2-gradient-background"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"placeholder":"Write title…","style":{"typography":{"textAlign":"center"}},"fontSize":"large"} -->
<p class="has-text-align-center has-large-font-size"></p>
<!-- /wp:paragraph --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:column --></div>
...
<p class="has-primary-color has-text-color has-link-color"><?php esc_html_e( '04', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":4,"style":{"spacing":{"margin":{"top":"var:preset|spacing|50"}}},"fontSize":"xxx-large"} -->
<h4 class="wp-block-heading has-xxx-large-font-size" style="margin-top:var(--wp--preset--spacing--50)"><?php esc_html_e( 'SEO & Growth Marketing', 'saaslauncher-agency' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|50"}}}} -->
<p style="margin-top:var(--wp--preset--spacing--50)"><?php esc_html_e( 'Technical SEO, content systems and paid experiments that compound into qualified pipeline.', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<p class="has-primary-color has-text-color has-link-color"><?php esc_html_e( '05', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":4,"style":{"spacing":{"margin":{"top":"var:preset|spacing|50"}}},"fontSize":"xxx-large"} -->
<h4 class="wp-block-heading has-xxx-large-font-size" style="margin-top:var(--wp--preset--spacing--50)"><?php esc_html_e( 'Conversion Optimization', 'saaslauncher-agency' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|50"}}}} -->
<p style="margin-top:var(--wp--preset--spacing--50)"><?php esc_html_e( 'Research, testing and UX refinement that lifts the numbers your board actually watches.', 'saaslauncher-agency' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
