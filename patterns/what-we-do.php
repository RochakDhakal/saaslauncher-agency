...
$saaslauncher_agency_url        = trailingslashit( get_stylesheet_directory_uri() );
	...
	?>
<!-- wp:group {"metadata":{"patternName":"saaslauncher-agency/what-we-do","name":"What We Do","categories":["saaslauncher-agency-patterns"]},"style":{"spacing":{"blockGap":"0","margin":{"top":"0","bottom":"0"},"padding":{"top":"120px","bottom":"120px","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}}},"layout":{"type":"constrained","contentSize":"1260px"}} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( $saaslauncher_agency_images[0] ); ?>","id":215,"dimRatio":0,"isUserOverlayColor":true,"minHeight":460,"sizeSlug":"full","style":{"border":{"radius":{"topLeft":"34px","topRight":"34px","bottomLeft":"34px","bottomRight":"34px"}}},"layout":{"type":"constrained"}} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( $saaslauncher_agency_images[2] ); ?>","id":215,"dimRatio":0,"isUserOverlayColor":true,"minHeight":460,"sizeSlug":"full","style":{"border":{"radius":{"topLeft":"34px","topRight":"34px","bottomLeft":"34px","bottomRight":"34px"}}},"layout":{"type":"constrained"}} -->
