...
<div class="wp-block-button is-style-button-with-uparrow-icon"><a class="wp-block-button__link has-black-color-color has-light-color-background-color has-text-color has-background has-link-color wp-element-button">Start Your Project</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-full is-resized"><img src="http://localhost:8080/wp-content/uploads/2026/08/hero-icon-1.png" alt="" class="wp-image-121" style="width:40px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
