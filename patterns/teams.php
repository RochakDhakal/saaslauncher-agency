...
<h2 class="wp-block-heading has-mega-font-size" style="margin-top:0">Sixteen people. No account managers in the middle.</h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<p>We keep the studio small on purpose. Everyone who pitches your project is someone who builds it — strategists, designers and engineers sharing one room and one standard.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->

<!-- wp:cover {"url":"http://localhost:8080/wp-content/uploads/2026/08/Rectangle-34625094-1024x599.jpg","id":573,"dimRatio":0,"isUserOverlayColor":true,"minHeight":760,"sizeSlug":"large","style":{"border":{"radius":{"topLeft":"34px","topRight":"34px","bottomLeft":"34px","bottomRight":"34px"},"width":"1px"},"spacing":{"margin":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}},"borderColor":"border-color","layout":{"type":"constrained"}} -->
<div class="wp-block-cover has-border-color has-border-color-border-color" style="border-width:1px;border-top-left-radius:34px;border-top-right-radius:34px;border-bottom-left-radius:34px;border-bottom-right-radius:34px;margin-top:var(--wp--preset--spacing--80);margin-bottom:var(--wp--preset--spacing--80);min-height:760px"><img class="wp-block-cover__image-background wp-image-573 size-large" alt="" src="http://localhost:8080/wp-content/uploads/2026/08/Rectangle-34625094-1024x599.jpg" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"></div></div>
<!-- /wp:cover -->
...
<figure class="wp-block-image size-full is-resized"><img src="http://localhost:8080/wp-content/uploads/2026/08/Ellipse-43772.png" alt="" class="wp-image-588" style="aspect-ratio:1;object-fit:cover;width:55px"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full is-resized"><img src="http://localhost:8080/wp-content/uploads/2026/08/Ellipse-43773.png" alt="" class="wp-image-597" style="aspect-ratio:1;object-fit:cover;width:55px"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full is-resized"><img src="http://localhost:8080/wp-content/uploads/2026/08/Ellipse-43774.png" alt="" class="wp-image-598" style="aspect-ratio:1;object-fit:cover;width:55px"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full is-resized"><img src="http://localhost:8080/wp-content/uploads/2026/08/Ellipse-43775.png" alt="" class="wp-image-599" style="aspect-ratio:1;object-fit:cover;width:55px"/></figure>
<!-- /wp:image -->
